...
# Slow trim: the integral's persistent content leaks into a per-joint
# feed-forward bias with a minutes-scale time constant, so slack buildup and
# calibration offset stop consuming integrator headroom. The clamp bounds the
# worst case of a wrong adaptation and doubles as the "recalibrate" signal.
DEFAULT_BIAS_TAU_S = 120.0
DEFAULT_BIAS_MAX_DEG = 3.0
