...
def test_write_joint_motor_travel_merges_and_keeps_other_keys(model_dir):
    ...
    assert doc["max_current"] == "default"  # untouched neighbours survive the rewrite
...
def test_config_rejects_a_retry_current_that_is_not_a_boost(model_dir):
    ...
    path = _write_config(model_dir, calibration_current=300, max_current=400,
                         calibration_retry_current=300)
